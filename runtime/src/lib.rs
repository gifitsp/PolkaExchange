...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-polkaexchange"),
	impl_name: create_runtime_str!("node-polkaexchange"),
	authoring_version: 1,
	spec_version: 100,
	impl_version: 1,
...
parameter_types! {
    pub const GetNativeCurrencyId: AssetId = AssetId::get_default_asset_id();
}
...
impl pallet_pool_amm::Config for Runtime {
	type Event = Event;
	type PoolId = PoolId;
}

impl pallet_pool_manager::Config for Runtime {
	type Event = Event;
}
